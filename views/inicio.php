...
<script type="text/javascript">
  document.querySelector('#btn_buscar').addEventListener('click', function(ev) {
    ...
    mesInicial = fields[1].value;
    mesFinal = fields[2].value;

    if (mesInicial > mesFinal) { // CORREÇÃO DO ERRO Validaçao de período      
      document.getElementById("validacaoMsg").textContent = "O Mês Inicial informado é maior que o mês final!";
    }else{
